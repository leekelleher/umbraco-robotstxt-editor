...
CALL build\tools\NuGet.exe restore src\Our.Umbraco.RobotsTxtEditor.sln
...
IF NOT EXIST "%toolsFolder%vswhere.exe" (
	...
	tools\NuGet.exe install vswhere -Version 2.6.7 -Source nuget.org -OutputDirectory tools
)
